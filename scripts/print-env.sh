...
echo "GNU debugger version:"

echo " - gdb:            $(gdb --version | grep gdb)"
echo " - gdb-multiarch:  $(gdb-multiarch --version | grep gdb)"
...
echo " - clang-format:   $(clang-format-6.0 --version | grep version | awk '{$1=$1};1')"
echo " - clang-tidy:     $(clang-tidy-6.0 --version | grep version | awk '{$1=$1};1')"
